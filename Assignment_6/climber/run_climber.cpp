...
int main(int argc, char *argv[])
{
    ...
    // if you get a "file not found" error, then you (or vscode) are not running the executable from
    // the right directory. Check that your "settings.json" file in the ".vscode" folder contains:
    //   "cmake.debugConfig": {
    //    "cwd": "${workspaceFolder}"
    //   }
